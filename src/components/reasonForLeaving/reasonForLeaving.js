                  ...
                  <div className="reasons">
                    <label>
                      <input
                        ...
                        name="reason"
                        value="reason1"
                        checked={this.state.checkedOption === "reason1"}
                        onChange={this.handleOptionChange}
                      />
                      <i></i>I don’t find Innovities useful.
                    </label>
                  </div>
                  <div className="reasons">
                    <label>
                      <input
                        ...
                        name="reason"
                        value="reason2"
                        checked={this.state.checkedOption === "reason2"}
                        onChange={this.handleOptionChange}
                      />
                      <i></i>I don’t understand how to use Innovities.
                    </label>
                  </div>
                  <div className="reasons">
                    <label>
                      <input
                        ...
                        name="reason"
                        value="reason3"
                        checked={this.state.checkedOption === "reason3"}
                        onChange={this.handleOptionChange}
                      />
                      <i></i>I get to many emails.
                    </label>
                  </div>
                  <div className="reasons">
                    <label>
                      <input
                        ...
                        name="reason"
                        value="reason4"
                        checked={this.state.checkedOption === "reason4"}
                        onChange={this.handleOptionChange}
                      />
                      <i></i>
